...
namespace StoreFrontLab.UI.MVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,EmployeeName,DirectReportID,DepartmentID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,EmployeeName,DirectReportID,DepartmentID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
